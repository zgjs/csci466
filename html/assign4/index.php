...
<span class="keyword">SELECT</span> <span class="keyword">DISTINCT</span> <span class="type">DATE_FORMAT</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">,</span><span class="string"> </span><span class="string">"</span><span class="format">%h</span><span class="string"> </span><span class="format">%i</span><span class="string"> </span><span class="format">%p</span><span class="string">"</span><span class="punct">)</span> <span class="keyword">AS</span> <span class="string">'Time'</span><span class="punct">,</span>
   <span class="type">IFNULL</span><span class="punct">(</span><span class="function">GROUP_CONCAT</span><span class="punct">(</span><span class="keyword">IF</span><span class="punct">(</span><span class="function">WEEKDAY</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">)</span> <span class="punct">=</span> <span class="number">6</span><span class="punct">,</span><span class="type">CONCAT</span><span class="punct">(</span>Client<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span><span class="punct">,</span> <span class="string">'-'</span><span class="punct">,</span> Appointment<span class="punct">.</span>`Service Name`<span class="punct">)</span><span class="punct">,</span><span class="punct">NULL</span><span class="punct">)</span> SEPARATOR <span class="string">', '</span><span class="punct">)</span><span class="punct">,</span><span class="string">'[Available]'</span><span class="punct">)</span> <span class="keyword">AS</span> <span class="string">'Sunday'</span><span class="punct">,</span>
   <span class="type">IFNULL</span><span class="punct">(</span><span class="function">GROUP_CONCAT</span><span class="punct">(</span><span class="keyword">IF</span><span class="punct">(</span><span class="function">WEEKDAY</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">)</span> <span class="punct">=</span> <span class="number">0</span><span class="punct">,</span><span class="type">CONCAT</span><span class="punct">(</span>Client<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span><span class="punct">,</span> <span class="string">'-'</span><span class="punct">,</span> Appointment<span class="punct">.</span>`Service Name`<span class="punct">)</span><span class="punct">,</span><span class="punct">NULL</span><span class="punct">)</span> SEPARATOR <span class="string">', '</span><span class="punct">)</span><span class="punct">,</span><span class="string">'[Available]'</span><span class="punct">)</span> <span class="keyword">AS</span> <span class="string">'Monday'</span><span class="punct">,</span>
   <span class="type">IFNULL</span><span class="punct">(</span><span class="function">GROUP_CONCAT</span><span class="punct">(</span><span class="keyword">IF</span><span class="punct">(</span><span class="function">WEEKDAY</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">)</span> <span class="punct">=</span> <span class="number">1</span><span class="punct">,</span><span class="type">CONCAT</span><span class="punct">(</span>Client<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span><span class="punct">,</span> <span class="string">'-'</span><span class="punct">,</span> Appointment<span class="punct">.</span>`Service Name`<span class="punct">)</span><span class="punct">,</span><span class="punct">NULL</span><span class="punct">)</span> SEPARATOR <span class="string">', '</span><span class="punct">)</span><span class="punct">,</span><span class="string">'[Available]'</span><span class="punct">)</span> <span class="keyword">AS</span> <span class="string">'Tuesday'</span><span class="punct">,</span>
   <span class="type">IFNULL</span><span class="punct">(</span><span class="function">GROUP_CONCAT</span><span class="punct">(</span><span class="keyword">IF</span><span class="punct">(</span><span class="function">WEEKDAY</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">)</span> <span class="punct">=</span> <span class="number">2</span><span class="punct">,</span><span class="type">CONCAT</span><span class="punct">(</span>Client<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span><span class="punct">,</span> <span class="string">'-'</span><span class="punct">,</span> Appointment<span class="punct">.</span>`Service Name`<span class="punct">)</span><span class="punct">,</span><span class="punct">NULL</span><span class="punct">)</span> SEPARATOR <span class="string">', '</span><span class="punct">)</span><span class="punct">,</span><span class="string">'[Available]'</span><span class="punct">)</span> <span class="keyword">AS</span> <span class="string">'Wednesday'</span><span class="punct">,</span>
   <span class="type">IFNULL</span><span class="punct">(</span><span class="function">GROUP_CONCAT</span><span class="punct">(</span><span class="keyword">IF</span><span class="punct">(</span><span class="function">WEEKDAY</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">)</span> <span class="punct">=</span> <span class="number">3</span><span class="punct">,</span><span class="type">CONCAT</span><span class="punct">(</span>Client<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span><span class="punct">,</span> <span class="string">'-'</span><span class="punct">,</span> Appointment<span class="punct">.</span>`Service Name`<span class="punct">)</span><span class="punct">,</span><span class="punct">NULL</span><span class="punct">)</span> SEPARATOR <span class="string">', '</span><span class="punct">)</span><span class="punct">,</span><span class="string">'[Available]'</span><span class="punct">)</span> <span class="keyword">AS</span> <span class="string">'Thursday'</span><span class="punct">,</span>
   <span class="type">IFNULL</span><span class="punct">(</span><span class="function">GROUP_CONCAT</span><span class="punct">(</span><span class="keyword">IF</span><span class="punct">(</span><span class="function">WEEKDAY</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">)</span> <span class="punct">=</span> <span class="number">4</span><span class="punct">,</span><span class="type">CONCAT</span><span class="punct">(</span>Client<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span><span class="punct">,</span> <span class="string">'-'</span><span class="punct">,</span> Appointment<span class="punct">.</span>`Service Name`<span class="punct">)</span><span class="punct">,</span><span class="punct">NULL</span><span class="punct">)</span> SEPARATOR <span class="string">', '</span><span class="punct">)</span><span class="punct">,</span><span class="string">'[Available]'</span><span class="punct">)</span> <span class="keyword">AS</span> <span class="string">'Friday'</span><span class="punct">,</span>
   <span class="type">IFNULL</span><span class="punct">(</span><span class="function">GROUP_CONCAT</span><span class="punct">(</span><span class="keyword">IF</span><span class="punct">(</span><span class="function">WEEKDAY</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">)</span> <span class="punct">=</span> <span class="number">5</span><span class="punct">,</span><span class="type">CONCAT</span><span class="punct">(</span>Client<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span><span class="punct">,</span> <span class="string">'-'</span><span class="punct">,</span> Appointment<span class="punct">.</span>`Service Name`<span class="punct">)</span><span class="punct">,</span><span class="punct">NULL</span><span class="punct">)</span> SEPARATOR <span class="string">', '</span><span class="punct">)</span><span class="punct">,</span><span class="string">'[Available]'</span><span class="punct">)</span> <span class="keyword">AS</span> <span class="string">'Saturday'</span>
<span class="keyword">FROM</span> Appointment
<span class="keyword">INNER</span> <span class="keyword">JOIN</span> Person <span class="keyword">AS</span> Client <span class="keyword">ON</span> Client<span class="punct">.</span><span class="punct">`</span>ID<span class="punct">`</span> <span class="punct">=</span>  Appointment<span class="punct">.</span>`Client ID`
<span class="keyword">INNER</span> <span class="keyword">JOIN</span> Person <span class="keyword">AS</span> Employee <span class="keyword">ON</span> Employee<span class="punct">.</span><span class="punct">`</span>ID<span class="punct">`</span> <span class="punct">=</span>  Appointment<span class="punct">.</span>`Employee ID`
<span class="keyword">WHERE</span> <span class="punct">`</span>Date<span class="punct">`</span> <span class="keyword">BETWEEN</span> <span class="type">DATE_ADD</span><span class="punct">(</span><span class="type">NOW</span><span class="punct">(</span><span class="punct">)</span><span class="punct">,</span><span class="type">INTERVAL</span> <span class="punct">-</span><span class="number">1</span> <span class="keyword">DAY</span><span class="punct">)</span> <span class="punct">AND</span> <span class="type">DATE_ADD</span><span class="punct">(</span><span class="type">NOW</span><span class="punct">(</span><span class="punct">)</span><span class="punct">,</span><span class="type">INTERVAL</span> <span class="number">6</span> <span class="keyword">DAY</span><span class="punct">)</span>
...
<span class="keyword">SELECT</span> <span class="keyword">DISTINCT</span> <span class="type">DATE_FORMAT</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">,</span><span class="string"> </span><span class="string">"</span><span class="format">%h</span><span class="string"> </span><span class="format">%i</span><span class="string"> </span><span class="format">%p</span><span class="string">"</span><span class="punct">)</span> <span class="keyword">AS</span> <span class="string">'Time'</span><span class="punct">,</span>
   <span class="type">IFNULL</span><span class="punct">(</span><span class="function">GROUP_CONCAT</span><span class="punct">(</span><span class="keyword">IF</span><span class="punct">(</span><span class="function">WEEKDAY</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">)</span> <span class="punct">=</span> <span class="number">6</span><span class="punct">,</span>Employee<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span><span class="punct">,</span><span class="punct">NULL</span><span class="punct">)</span> <span class="keyword">ORDER</span> <span class="keyword">BY</span> Employee<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span> SEPARATOR <span class="string">', '</span><span class="punct">)</span><span class="punct">,</span><span class="string">'[Unscheduled]'</span><span class="punct">)</span> <span class="keyword">AS</span> <span class="string">'Sunday'</span><span class="punct">,</span>
   <span class="type">IFNULL</span><span class="punct">(</span><span class="function">GROUP_CONCAT</span><span class="punct">(</span><span class="keyword">IF</span><span class="punct">(</span><span class="function">WEEKDAY</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">)</span> <span class="punct">=</span> <span class="number">0</span><span class="punct">,</span>Employee<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span><span class="punct">,</span><span class="punct">NULL</span><span class="punct">)</span> <span class="keyword">ORDER</span> <span class="keyword">BY</span> Employee<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span> SEPARATOR <span class="string">', '</span><span class="punct">)</span><span class="punct">,</span><span class="string">'[Unscheduled]'</span><span class="punct">)</span> <span class="keyword">AS</span> <span class="string">'Monday'</span><span class="punct">,</span>
   <span class="type">IFNULL</span><span class="punct">(</span><span class="function">GROUP_CONCAT</span><span class="punct">(</span><span class="keyword">IF</span><span class="punct">(</span><span class="function">WEEKDAY</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">)</span> <span class="punct">=</span> <span class="number">1</span><span class="punct">,</span>Employee<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span><span class="punct">,</span><span class="punct">NULL</span><span class="punct">)</span> <span class="keyword">ORDER</span> <span class="keyword">BY</span> Employee<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span> SEPARATOR <span class="string">', '</span><span class="punct">)</span><span class="punct">,</span><span class="string">'[Unscheduled]'</span><span class="punct">)</span> <span class="keyword">AS</span> <span class="string">'Tuesday'</span><span class="punct">,</span>
   <span class="type">IFNULL</span><span class="punct">(</span><span class="function">GROUP_CONCAT</span><span class="punct">(</span><span class="keyword">IF</span><span class="punct">(</span><span class="function">WEEKDAY</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">)</span> <span class="punct">=</span> <span class="number">2</span><span class="punct">,</span>Employee<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span><span class="punct">,</span><span class="punct">NULL</span><span class="punct">)</span> <span class="keyword">ORDER</span> <span class="keyword">BY</span> Employee<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span> SEPARATOR <span class="string">', '</span><span class="punct">)</span><span class="punct">,</span><span class="string">'[Unscheduled]'</span><span class="punct">)</span> <span class="keyword">AS</span> <span class="string">'Wednesday'</span><span class="punct">,</span>
   <span class="type">IFNULL</span><span class="punct">(</span><span class="function">GROUP_CONCAT</span><span class="punct">(</span><span class="keyword">IF</span><span class="punct">(</span><span class="function">WEEKDAY</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">)</span> <span class="punct">=</span> <span class="number">3</span><span class="punct">,</span>Employee<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span><span class="punct">,</span><span class="punct">NULL</span><span class="punct">)</span> <span class="keyword">ORDER</span> <span class="keyword">BY</span> Employee<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span> SEPARATOR <span class="string">', '</span><span class="punct">)</span><span class="punct">,</span><span class="string">'[Unscheduled]'</span><span class="punct">)</span> <span class="keyword">AS</span> <span class="string">'Thursday'</span><span class="punct">,</span>
   <span class="type">IFNULL</span><span class="punct">(</span><span class="function">GROUP_CONCAT</span><span class="punct">(</span><span class="keyword">IF</span><span class="punct">(</span><span class="function">WEEKDAY</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">)</span> <span class="punct">=</span> <span class="number">4</span><span class="punct">,</span>Employee<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span><span class="punct">,</span><span class="punct">NULL</span><span class="punct">)</span> <span class="keyword">ORDER</span> <span class="keyword">BY</span> Employee<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span> SEPARATOR <span class="string">', '</span><span class="punct">)</span><span class="punct">,</span><span class="string">'[Unscheduled]'</span><span class="punct">)</span> <span class="keyword">AS</span> <span class="string">'Friday'</span><span class="punct">,</span>
   <span class="type">IFNULL</span><span class="punct">(</span><span class="function">GROUP_CONCAT</span><span class="punct">(</span><span class="keyword">IF</span><span class="punct">(</span><span class="function">WEEKDAY</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">)</span> <span class="punct">=</span> <span class="number">5</span><span class="punct">,</span>Employee<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span><span class="punct">,</span><span class="punct">NULL</span><span class="punct">)</span> <span class="keyword">ORDER</span> <span class="keyword">BY</span> Employee<span class="punct">.</span><span class="punct">`</span>Name<span class="punct">`</span> SEPARATOR <span class="string">', '</span><span class="punct">)</span><span class="punct">,</span><span class="string">'[Unscheduled]'</span><span class="punct">)</span> <span class="keyword">AS</span> <span class="string">'Saturday'</span>
<span class="keyword">FROM</span> Appointment
<span class="keyword">INNER</span> <span class="keyword">JOIN</span> Person <span class="keyword">AS</span> Employee <span class="keyword">ON</span> Employee<span class="punct">.</span><span class="punct">`</span>ID<span class="punct">`</span> <span class="punct">=</span>  Appointment<span class="punct">.</span>`Employee ID`
<span class="keyword">WHERE</span> <span class="punct">`</span>Date<span class="punct">`</span> <span class="keyword">BETWEEN</span> <span class="type">DATE_ADD</span><span class="punct">(</span><span class="type">NOW</span><span class="punct">(</span><span class="punct">)</span><span class="punct">,</span><span class="type">INTERVAL</span> <span class="punct">-</span><span class="number">1</span> <span class="keyword">DAY</span><span class="punct">)</span> <span class="punct">AND</span> <span class="type">DATE_ADD</span><span class="punct">(</span><span class="type">NOW</span><span class="punct">(</span><span class="punct">)</span><span class="punct">,</span><span class="type">INTERVAL</span> <span class="number">6</span> <span class="keyword">DAY</span><span class="punct">)</span>
<span class="keyword">GROUP</span> <span class="keyword">BY</span> <span class="function">TIME</span><span class="punct">(</span><span class="punct">`</span>Date<span class="punct">`</span><span class="punct">)</span><span class="punct">;</span></pre>
...
<span class="keyword">INNER</span> <span class="keyword">JOIN</span> Person <span class="keyword">AS</span> Client <span class="keyword">ON</span> Client<span class="punct">.</span><span class="punct">`</span>ID<span class="punct">`</span> <span class="punct">=</span> Appointment<span class="punct">.</span>`Client ID`
<span class="keyword">INNER</span> <span class="keyword">JOIN</span> Person <span class="keyword">AS</span> Employee <span class="keyword">ON</span> Employee<span class="punct">.</span><span class="punct">`</span>ID<span class="punct">`</span> <span class="punct">=</span> Appointment<span class="punct">.</span>`Employee ID`
<span class="keyword">WHERE</span> <span class="punct">`</span>Date<span class="punct">`</span> <span class="keyword">BETWEEN</span> <span class="type">DATE_ADD</span><span class="punct">(</span><span class="type">NOW</span><span class="punct">(</span><span class="punct">)</span><span class="punct">,</span><span class="type">INTERVAL</span> <span class="number">1</span> <span class="keyword">DAY</span><span class="punct">)</span> <span class="punct">AND</span> <span class="type">DATE_ADD</span><span class="punct">(</span><span class="type">NOW</span><span class="punct">(</span><span class="punct">)</span><span class="punct">,</span><span class="type">INTERVAL</span> <span class="number">3</span> <span class="keyword">DAY</span><span class="punct">)</span>
<span class="keyword">ORDER</span> <span class="keyword">BY</span> <span class="punct">`</span>Date<span class="punct">`</span> <span class="keyword">ASC</span> <span class="keyword">LIMIT</span> <span class="number">20</span><span class="punct">;</span></pre>
    </p>
